...
class MVBImageTextTrackDisplayCell: MQPictureBrowserCell {
    ...
    func configurePictureCell(imageTextTrack: MVBImageTextTrackModel, thumbImage: UIImage?) {
        ...
        imageView.sd_setImageWithURL(NSURL(string: imageTextTrack.originImageFileUrl)!, placeholderImage: thumbImage, options: .RetryFailed, progress: { [weak self] (receivedSize, expectedSize) -> Void in
