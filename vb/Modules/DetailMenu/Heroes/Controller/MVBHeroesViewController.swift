...
extension MVBHeroesViewController {
    func getHeroesModel() {
        ...
        requestOperate.GET(kDota2HeroesUrl, parameters: param, success: {
            ...
            self.heroesInfo = MVBHeroesInfoModel().mj_setKeyValues(resultDic["result"])
            self.heroesInfo.heroseModelArray = NSMutableArray(array:MVBHeroModel.mj_objectArrayWithKeyValuesArray(self.heroesInfo.heroesDicArray))
